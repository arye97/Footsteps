...
export default {
  ...
  getActivityByActivityTitle: (activityNames, minFitnessLevel, maxFitnessLevel, pageNumber) => {
    ...
    return server.get(`/activities?activityKeywords=${uri}&minFitnessLevel=${minFitnessLevel}&maxFitnessLevel=${maxFitnessLevel}`, getExtendedPageNumberTokenHeader(pageNumber))
  },
  getActivityByActivityType: (activityTypes, method, minFitnessLevel, maxFitnessLevel, pageNumber) => {    // method denotes "and" or "or"
    ...
    return server.get(`activities?activity=${activityTypesStr}&method=${method}&minFitnessLevel=${minFitnessLevel}&maxFitnessLevel=${maxFitnessLevel}`, getExtendedPageNumberTokenHeader(pageNumber))
  },
  getActivityPinsByLocation: (coordinates, activityTypes, cutoffDistance, method, minFitnessLevel, maxFitnessLevel, pageNumber) => {
    ...
    return server.get(`/activities/pins?coordinates=${coordinates}&activityTypes=${activityTypesStr}&cutoffDistance=${cutoffDistance}&method=${method}&minFitnessLevel=${minFitnessLevel}&maxFitnessLevel=${maxFitnessLevel}`,
  ...
  getActivityByLocation: (coordinates, activityTypes, cutoffDistance, method, minFitnessLevel, maxFitnessLevel, pageNumber) => {
    let activityTypesStr = activityTypes.map(a => a.replace(/\s/g, '-')).join(' ');
    return server.get(`/activities?coordinates=${coordinates}&activityTypes=${activityTypesStr}&cutoffDistance=${cutoffDistance}&method=${method}&minFitnessLevel=${minFitnessLevel}&maxFitnessLevel=${maxFitnessLevel}`,
        getExtendedPageNumberTokenHeader(pageNumber))
  },
  getNumberOfRowsForActivityByLocation: (coordinates, activityTypes, cutoffDistance, minFitnessLevel, maxFitnessLevel, method) => {
    let activityTypesStr = activityTypes.map(a => a.replace(/\s/g, '-')).join(' ');
    return server.get(`/activities/rows?coordinates=${coordinates}&activityTypes=${activityTypesStr}&cutoffDistance=${cutoffDistance}&method=${method}&minFitnessLevel=${minFitnessLevel}&maxFitnessLevel=${maxFitnessLevel}`,
        getTokenHeader())
  },
