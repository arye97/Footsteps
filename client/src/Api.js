...
export default {
  ...
  getActivitiesByLocation: (cutoffDistance, pageNumber) => {    // method denotes "and" or "or"
    return server.get(`activities?activity-distance=${cutoffDistance}`, getExtendedPageNumberTokenHeader(pageNumber))
  },
